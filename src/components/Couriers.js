...
class Sender extends Component {
  ...
  componentWillMount() {
    this.props.getCouriersDataWatcher();
  };
  handleSubmit(data) {
  ...
  render() { 
    const { classes, couriers, panel } = this.props;
    const { page, rowsPerPage } = this.state;
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, couriers.length - page * rowsPerPage);
    return ( 
          ...
          <div className={ classes.tableWrapper }>
            <Table className={classes.table}>
              ...
              <TableBody>              
              {
                ...
                couriers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
                <TableRow
